		...
		<div class="box">
			...
			<el-form ref="form2" :model="form2" label-width="80px" class="up_form">
				...
				<div style="width: 35%;float:left;padding:15px;">
					...
					<el-select :disabled="true" v-model="value" name="classifyType" placeholder="请选择">
					...
					<el-form-item label="发布账号:" prop="userId" label-width="82">
						<el-select :disabled="true" v-model="form2.userId" placeholder="请选择发布账号">
					...
					<el-form-item label="附加选项:" prop="imgType" label-width="82">
						<el-radio-group :disabled="true" v-model="form2.imgType">
					...
					<el-form-item label="Tag标签:">
						<el-input :disabled="true"  placeholder="用逗号隔开，单个标签少于12字节" v-model="form2.tagLabel"></el-input>
					</el-form-item>
