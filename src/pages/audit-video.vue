          ...
          <div>
            <el-table :data="audit_all" border stripe v-loading="loading" :row-class-name="btnTable" :header-row-class-name="btnTable" >
              ...
              <el-table-column label="操作" width="80" fixed="right">
                <template slot-scope="scope">
                  <router-link :to="{name:'video-second',params:{id:scope.row.id,argu:{a:value,b:value6,c:search_pra,d:activeName,e:per_page1,f:currentPage1,g:per_page2,h:currentPage2}}}" > 
          ...
          <div>
            ...
            <el-table :data="audit_no" border stripe :row-class-name="btnTable" :header-row-class-name="btnTable" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="操作" width="50" fixed="right">
                <template slot-scope="scope">
                    <router-link :to="{name:'video-second',params:{id:scope.row.id,argu:{a:value,b:value6,c:search_pra,d:activeName,e:per_page1,f:currentPage1,g:per_page2,h:currentPage2}}}" > <el-button type="text" v-if="scope.row.status=='1'||scope.row.status=='3'" style="margin-right:8px;vertical-align:middle;">审核</el-button></router-link>
                    <router-link :to="{name:'video-lookes',params:{id:scope.row.id}}" ><el-button v-if="scope.row.status=='3' || scope.row.status=='4' "  type="text" style="margin-right:8px;vertical-align:middle;">查看</el-button></router-link>
                </template>
              </el-table-column>
            </el-table>
            <div style="margin-top:20px;">
            ...
            <el-table :data="audit_no" border stripe :row-class-name="btnTable" :header-row-class-name="btnTable" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="操作" width="50" fixed="right">
                <template slot-scope="scope">
                    ...
                    <router-link :to="{name:'video-lookes',params:{id:scope.row.id}}" ><el-button  type="text" style="margin-right:8px;vertical-align:middle;">查看</el-button></router-link>
                </template>
              </el-table-column>
            </el-table>
            <div style="margin-top:20px;">
